...
the first time. Your originals are never changed, moved, or deleted.
...
| **5 Copy** | Copies into the clean structure and writes the reviewed metadata everywhere: `metadata.opf`, `metadata.json`, `cover.jpg`, and the tags and cover *inside* the copied audio files and epubs. |
